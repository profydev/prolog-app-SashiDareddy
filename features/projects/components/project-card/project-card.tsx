...
const statusDisplay = {
  [ProjectStatus.info]: ProjectStatusDisplay.info,
  [ProjectStatus.warning]: ProjectStatusDisplay.warning,
  [ProjectStatus.error]: ProjectStatusDisplay.error,
};
      ...
      <div className={styles.topContainer}>
        ...
        <div className={styles.infoContainer}>
          ...
          <div className={styles.status}>
            <Badge color={statusColors[status]}>{statusDisplay[status]}</Badge>
          </div>
        </div>
      </div>
